...
app.post("/sync/pull", async (c) => {
  ...
  const mapTab = /* @__PURE__ */ __name((row) => ({
    id: row.id,
    url: row.url,
    title: row.title,
    favicon: row.favicon,
  ...
  const mapGroup = /* @__PURE__ */ __name((row) => ({
    id: row.id,
    name: row.name,
  ...
  const mapCapture = /* @__PURE__ */ __name((row) => ({
    id: row.id,
    capturedAt: row.captured_at,
    sourceLabel: row.source_label,
...
// .wrangler/tmp/bundle-gaxDs8/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-gaxDs8/middleware-loader.entry.ts
