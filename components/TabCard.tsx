      ...
      <div class="aspect-video rounded-xl overflow-hidden bg-muted/40 mb-3 relative">
        ...
        <div class="absolute top-2 left-2 flex gap-1.5">
          <Show when={props.isTrash}>
            <button
              class="p-2 rounded-lg text-foreground/90 bg-black/70 hover:bg-sky-500/40 transition-colors opacity-0 group-hover:opacity-100"
          ...
          <Show when={!props.isTrash}>
            ...
            <button
              class={`p-2 rounded-lg transition-all ${
                props.tab.starred
                  ? "text-yellow-400 drop-shadow-md group-hover:bg-black/70 group-hover:drop-shadow-none hover:!bg-sky-500/40"
                  : "text-foreground/90 bg-black/70 hover:bg-sky-500/40 opacity-0 group-hover:opacity-100"
              }`}
